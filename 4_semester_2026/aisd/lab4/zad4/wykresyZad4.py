...
def main():
    path = sys.argv[1] if len(sys.argv) > 1 else "wyniki4.csv"
    ...
    fig.suptitle("Zadanie 4 - charakterystyka splay tree", fontsize=15)
    plt.tight_layout(rect=(0, 0, 1, 0.97))

    output_path = "zad4_wykresy.png"
